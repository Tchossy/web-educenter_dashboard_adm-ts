...
import { MultipleChoiceOptionsModal } from '../../MultipleChoiceOptionsModal'
...
export function ModalCreateTaskQuestion({
  handleUpdateListing,
  modalCreateRowIsOpen,
  setModalCreateRowIsOpen
}: modalCreateType<TaskQuestionInterface>) {
  // Params
  ...
  async function handleSubmitForm(dataForm: any) {
    ...
    try {
      ...
      const resultSubmit = await TaskQuestionViewModel.create(dataToSave)
