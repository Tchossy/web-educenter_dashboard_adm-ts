...
// Table
import { TableRowMaterial } from '../../components/table/TableRowMaterial'
...
import { ModalSeeMaterial } from '../../components/modal/material/ModalSee'
import { materialData } from '../../data/tableData'
...
export function Material() {
  ...
  const rowsTable = materialData.map((item, index) => {
    return (
      <TableRowMaterial
        key={index}
        rowItem={item}
  ...
  function handleDeleteRow(id: string) {
    swal({
      ...
      if (willDelete) {
        ...
        swal('O materialistrador está seguro!', {
          icon: 'error'
        })
      }
    })
