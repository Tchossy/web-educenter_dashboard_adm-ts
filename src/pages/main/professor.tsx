...
import { professorData } from '../../data/tableData'
...
export function Professor() {
  ...
  const rowsTable = professorData.map((item, index) => {
    return (
      <TableRow
        key={index}
        rowItem={item}
  ...
  function handleDeleteRow(id: string) {
    swal({
      ...
      if (willDelete) {
        ...
        swal('O professoristrador está seguro!', {
          icon: 'error'
        })
      }
    })
